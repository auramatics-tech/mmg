...
class PropertyDetail extends Model
{
    ...
    protected $fillable = [
        ...
        'rental_allowances','outdoor','indoor','heating_cooling','eco_friendly','other_features','total_floor_area','floor_area_units','office_area',
        'office_area_units','warehouse_area','warehouse_units','total_car_spaces','parking_comments','tenancy','zoning'
    ];
}
