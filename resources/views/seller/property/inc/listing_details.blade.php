    ...
    <form action="{{route('seller.save_listing_details')}}" method="POST" onsubmit="setFormSubmitting()">
        ...
        <div id="about_listing" class="collapse show">
            ...
            <div class="d-flex flex-column mb-7 fv-row commercial_show">
                ...
                <select class="form-control form-control-solid" name="commercial_listing_type" id="property_commercial_listing_type" data-placeholder="Select a commercial type">
            ...
            <div class="d-flex flex-column mb-7 fv-row commercial_show business_show">
                ...
                @error('commercial_property_type')
                <span class="text-danger">{{$message}}</span>
                @enderror
            ...
            <div class="row g-9 mb-8">
                <div class="col-md-6 mb-8 fv-row">
                    ...
                    <input class="form-control form-control-solid" id="StartDate" placeholder="" name="start_expiry_date" type="date" value="{{old('start_expiry_date') ?? isset($property->start_expiry_date)?$property->start_expiry_date:''}}" />
                </div>
                <div class="col-md-6 mb-8 fv-row">
                    <label class="fs-6 fw-bold mb-2"> Expiry Date</label>
                    <input class="form-control form-control-solid" id="EndDate" placeholder="" name="end_expiry_date" type="date" value="{{old('end_expiry_date') ?? isset($property->end_expiry_date)?$property->end_expiry_date:''}}" />
                </div>
            </div>
        ...
        <div id="" class="collapse show commercial_lease_show"" ">
            <div class="d-flex flex-column mb-7 fv-row">
            ...
            <div class="d-flex flex-column mb-7 fv-row">
                <label class="fs-6 fw-bold mb-2">Outgoings</label>
                <input class="form-control form-control-solid" placeholder="" type="number" name="commercial_outgoings" value="" />
                @error('commercial_outgoings')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
            <div class="d-flex flex-column mb-7 fv-row">
                <label class="fs-6 fw-bold mb-2">Lease Term</label>
