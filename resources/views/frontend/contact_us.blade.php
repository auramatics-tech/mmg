        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ltn__form-box contact-form-box box-shadow white-bg">
                    ...
                    <form id="contact-form" method="post" action="{{route('save_contact_us')}}">
                        @csrf
                        <div class="row">
                            @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="input-item">
                                    <select class="nice-select" name="service_type" value="{{old('service_type')}}">
                                        <option value="">Select Service Type </option>
                                        <option value="property_management">Property Management </option>
                                        <option value="mortgage_service">Mortgage Service </option>
                                        <option value="consulting_service">Consulting Service</option>
                                        <option value="home_buying">Home Buying</option>
                                        <option value="home_selling">Home Selling</option>
                                        <option value="escrow_services">Escrow Services</option>
                                    </select>
                                </div>
                            </div>
                            @error('phone')
                            ...
                            <div class="col-md-6">
                                <div class="input-item input-item-phone ltn__custom-icon ">
                                    <input class="form-control" style="height:64px" type="number" name="phone" placeholder="Enter phone number" value="{{old('phone')}}">
                                </div>
                            </div>
                        </div>
                        @error('message')
                ...
                <div class="btn-wrapper mt-0">
                    <button class="btn theme-btn-1 btn-effect-1 text-uppercase" id="contact_submit_btn" type="submit">get a free service</button>
                </div>
...
@section('script')
<!-- <script>
    $(document).on('click', '#contact_submit_btn', function() {
        $.ajax({
            method: "POST",
