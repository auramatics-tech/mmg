	...
	<div class="toolbar" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Favourite Properties List</h1>
			</div>
		</div>
	</div>
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
						...
						<tbody class="text-gray-600 fw-bold">
							...
							<tr>
								...
								<td>
									<div class="badge badge-light fw-bolder">@if($property->form_type == 'residential_sale' || $property->commercial_listing_type == 'commercial_sale')
								...
								@endif
								<td>{{isset($property->start_expiry_date)?date('d-m-Y',strtotime($property->start_expiry_date)):''}}</td>
								<td class="d-flex">
									<div class="me-0">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<a href="{{route('property_details',$property->id)}}" class="menu-link px-3 copy_link">Book for inspection</a>
										</div>
										<div class="menu-item px-3">
											<a href="{{route('buyer.property_bid',$property->id)}}" class="menu-link px-3 copy_link">Offer</a>
										</div>
									</div>
								</td>
							</tr>
