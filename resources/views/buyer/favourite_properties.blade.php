												...
												<tr>
													...
													<td class="d-flex">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														    ...
														    <div class="menu-item px-3">
																<a href="{{route('buyer.book_inspection',$property->id)}}" class="menu-link px-3 copy_link">Book for inspection</a>
															</div>
														    <div class="menu-item px-3">
																<a href="{{route('buyer.offer_form',$property->id)}}" class="menu-link px-3 copy_link">Offer</a>
															</div>
														</div>
														<!--end::Menu-->
													</td>
