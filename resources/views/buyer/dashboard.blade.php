										...
										<div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
											...
											<div class="card card-flush h-md-50 mb-xl-10">
												...
												<div class="card-header pt-5">
													...
													<div class="card-title d-flex flex-column">
														<!--begin::Amount-->
														<span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2">{{isset($seller['my_property_views'])?$seller['my_property_views']:'0'}}</span>
														<!--end::Amount-->
														<!--begin::Subtitle-->
														<span class="text-gray-400 pt-1 fw-bold fs-6">My Total Properties Views</span>
														<!--end::Subtitle-->
													</div>
													<!--end::Title-->
												</div>
												...
												<div class="card-header pt-5">
													...
													<div class="card-title d-flex flex-column">
														...
														<div class="d-flex align-items-center">
															...
															<!--end::Currency-->
															<!--begin::Amount-->
															<span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2">{{isset($buyer['offers'])? $buyer['offers']:'0'}}</span>
															<!--end::Amount-->
														</div>
														<!--end::Info-->
														<!--begin::Subtitle-->
														<span class="text-gray-400 pt-1 fw-bold fs-6">My Total Offers</span>
														<!--end::Subtitle-->
													</div>
													<!--end::Title-->
												</div>
