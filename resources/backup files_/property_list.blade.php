                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <label class="checkbox-item">Residental
                                        <input type="checkbox" @if(isset(request()->type) && in_array("residential", request()->type)) checked @endif value="residential" name="type[]">
...
<script>
    $(document).on('change', '#form2 input:checkbox:checked', function() {
        $('#form2').submit();
    });
</script>
<script>
    $(document).on('change', '#form3 input:checkbox:checked', function() {
        $('#form3').submit();
    });
</script>
